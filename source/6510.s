...
nr0
	...
	ldr pc,[sp],#4
normalops
	.word _10,_30,_4C,_50,_70,_90,_B0,_D0,_F0
jmpops
	.word _10,_30,_4Cx,_50,_70,_90,_B0,_D0,_F0
hackops
	.word _10y,_30y,0,0,_70,_90y,_B0y,_D0y,_F0y
opindex
	.word op_table+0x10*4,op_table+0x30*4,op_table+0x4C*4,op_table+0x50*4,op_table+0x70*4
	.word op_table+0x90*4,op_table+0xB0*4,op_table+0xD0*4,op_table+0xF0*4
...
cpustate
	...
	.word 0 ;nexttimeout_:  backup of nexttimeout
	.word 0 ;oldcycles:  backup of cycles
	.word 0 ;scanline
	.word 0 ;scanlinehook
	.word 0 ;cyclesperscanline (63*CYCLE)
	.word 0 ;lastscanline (311)
